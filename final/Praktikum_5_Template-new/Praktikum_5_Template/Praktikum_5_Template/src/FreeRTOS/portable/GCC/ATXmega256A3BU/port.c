 ...
 * This is port of AVR XMega for freeRTOS V8.2.3
 *
 * Note:
 * Using TCC0 timer
 * Assuming RAMPD, RAMPX, RAMPY, RAMPZ, and EIND are not part of execution-context
 */
...
/*
 * Perform hardware setup to enable ticks from TCC0.
 */
